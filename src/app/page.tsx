...
export default async function HomePage() {
  // Fetch in parallel; gracefully degrade to fallback UI on error
  ...
  return (
    <div className="relative min-h-screen">
      {/* Pastel blob field — fixed background */}
      ...
      <div className="relative z-10">
        ...
        <main>
          <Hero />
          <Categories
            categories={categories.status === "fulfilled" ? categories.value : undefined}
          />
          <Stars />
          <Benefits />
          <Products
            products={products.status === "fulfilled" ? products.value : undefined}
          />
          <WhyUs />
          <AboutBanner />
          <Retailers />
